...
//   // Call hooks (sendSocketAction, useEffect) unconditionally before any early returns
//   React.useEffect(() => {
//     // If it's a group and we don't have participant details, request full conversation
//     // from server. We assume server accepts action "getConversation" with { conversationId }
//     // and will push a "getConversationResponse" containing the conversation (including participants).
//     try {
//       const isGroupNow = (conversation?.type?.lookupCode ?? '').toLowerCase() === 'group'
//       if (isGroupNow && conversation && (!conversation.conversationParticipants || conversation.conversationParticipants.length === 0)) {
//         sendSocketAction("getConversation", { conversationId: conversation.id })
//       }
//     } catch (e) {}
//     // eslint-disable-next-line react-hooks/exhaustive-deps
...
//                                   : "—"}
//                                 {p?.leftAt
//                                   ? " left at : "+new Date(p.leftAt).toLocaleDateString()
//                                   : "—"}
//                               </div>
//                             </div>
//                           </div>
